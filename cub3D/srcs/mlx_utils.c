...
/*   Updated: 2021/04/26 11:47:54 by afulmini         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_mlx_var(t_mlx *d)
{
	...
	d->img.img = mlx_new_image(d->mlx_ptr, d->p.screen_width, d->p.screen_heigth);
	d->img.address = mlx_get_data_addr(d->img.img, &d->img.bits_per_pixel,
				&d->img.line_length, &d->img.endian);
	d->img1.img = mlx_new_image(d->mlx_ptr, d->p.screen_width, d->p.screen_heigth);
